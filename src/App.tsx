...
import ManagerProjects from "./pages/Modern/ModernProjectsPage";
...
import ManagerLabels from "./pages/Modern/ModernLabelsPage";
import CreateLabel from "./pages/Manager/CreateLabel";
import ManagerPolicies from "./pages/Modern/ModernPoliciesPage";
