    ...
    return (
        <div className="p-8 space-y-6 max-w-2xl">
            <div className="flex items-center gap-3">
                <button onClick={() => navigate("/manager/labels")} className="text-muted-foreground hover:text-foreground transition-colors">
            ...
            <Card className="p-6 space-y-5">
                ...
                <div>
                    ...
                    {errors.labelType && <p className="text-xs text-destructive mt-1">{errors.labelType}</p>}
                </div>
