...
export default function LabelSelectModal({ labelGroups = [], initialSelectedIds = [], onSave, onCancel }) {
    ...
    const searchRuleGroups = React.useMemo(() => {
        ...
        return labelGroups
            ...
            .filter((g) => g.labels.length > 0 || g.ruleName?.toLowerCase().includes(q));
    }, [search, labelGroups, isSearching]);
                    ...
                    <div className="flex flex-1 overflow-hidden">
                        <div className="flex-1 overflow-y-auto p-3 space-y-4">
                            ...
                            {isSearching && viewMode === null ? (
                                    ...
                                    return (
                                        <>
                                            ...
                                            {hasLabels && (
                                                <div>
                                                    <div className="flex items-center gap-1.5 mb-2">
                                                        <span className="material-symbols-outlined" style={{ fontSize: 13, color: "#4a6788" }}>label</span>
                                                        <span className="text-[11px] font-semibold" style={{ color: "#4a6788" }}>
                                            ...
                                            {hasRules && (
                                                <div>
                                                    <div className="flex items-center gap-1.5 mb-2">
                                                        <span className="material-symbols-outlined" style={{ fontSize: 13, color: "#4a6788" }}>rule</span>
                                                        <span className="text-[11px] font-semibold" style={{ color: "#4a6788" }}>
                                ...
                                (() => {
                                    const displayGroups = isSearching ? searchRuleGroups : labelGroups;
