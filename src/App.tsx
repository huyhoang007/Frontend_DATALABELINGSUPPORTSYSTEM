...
import ManagerProjects from "./pages/Manager/ProjectsPage";
      ...
      <BrowserRouter>
        ...
        <Routes>
            ...
            <Route path="/annotator" element={<RoleGuard allowedRoles={["ANNOTATOR"]}><AnnotatorLayout /></RoleGuard>}>
              ...
              <Route path="dashboard" element={<AnnotatorDashboard user={JSON.parse(localStorage.getItem("user") || "{}")} />} />
              <Route path="tasks" element={<TaskList />} />
            </Route>
            <Route path="/annotator/task/:taskId" element={<RoleGuard allowedRoles={["ANNOTATOR"]}><Workspace /></RoleGuard>} />

            {/* Reviewer */}
            <Route path="/reviewer" element={<RoleGuard allowedRoles={["REVIEWER"]}><ReviewerLayout /></RoleGuard>}>
