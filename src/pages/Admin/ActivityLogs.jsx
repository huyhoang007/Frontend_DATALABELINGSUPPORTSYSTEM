                    ...
                    <div className="bg-card border border-border rounded-lg overflow-hidden">
                        {isLoading ? (
                            ...
                            <div className="text-center text-muted-foreground py-12">
                                ...
                                <p className="text-sm">Activity logs will appear here when users perform actions</p>
                            </div>
                        ) : (
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold">
                                                        {log.username?.[0]?.toUpperCase() || log.userId?.[0] || '?'}
                                                    </div>
                        ...
                        {!isLoading && logs.length > logsPerPage && (
                            <div className="flex items-center justify-between p-4 border-t border-border">
                                <div className="text-sm text-muted-foreground">
                                    Hiển thị {indexOfFirstLog + 1}-{Math.min(indexOfLastLog, logs.length)} / {logs.length} hoạt động
                                </div>
